...
class SolutionEntity(Base):
    ...
    # Primary Key
    id = Column(Integer, primary_key=True, autoincrement=True, comment="Solution ID")
    ...
    # 솔루션 정보
    sol = Column(Text, nullable=False, comment="솔루션 내용")
...
class CompanyEntity(Base):
    ...
    # Primary Key
    id = Column(Integer, primary_key=True, autoincrement=True, comment="Company ID")
